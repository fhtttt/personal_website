    ...
    <section class="section" data-nosnippet>
      ...
      <div class="acad">
        ...
        <div class="item">
          ...
          <div class="body">
            <p class="deg">Spanish · Korean · Arabic · Hebrew · Thai · Portuguese · Norwegian · Turkish · Greek · Suzhou&nbsp;Wu · Hindi · Chinese&nbsp;National&nbsp;Sign&nbsp;Language</p>
    ...
    <section class="section" data-nosnippet>
      ...
      <div class="acad epiph">
        ...
        <div class="item">
          ...
          <div class="body">
            <p class="deg">that to see no difference among lives is to treat them with indifference.</p>
          </div>
        </div>
      </div>
    </section>
